...
# Run the script block as another user
Start-Process powershell -ArgumentList "-NoProfile -ExecutionPolicy Bypass -Command & {& $scriptBlock -computerName $computerName}" -Credential $credential -NoNewWindow -Wait
