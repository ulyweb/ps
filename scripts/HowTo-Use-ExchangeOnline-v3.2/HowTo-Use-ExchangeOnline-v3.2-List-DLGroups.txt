...
# By following these steps, you will ensure you are only using version 3.2.0 of the 
# ExchangeOnlineManagement module in PowerShell ISE and can successfully list your distribution group.
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
#
# Summary Table
...
#|| Import v3.2.0 4 in ISE   | Import-Module ExchangeOnlineManagement -RequiredVersion 3.2.0        ||
